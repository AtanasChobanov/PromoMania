import { pgTable, varchar, timestamp, text, integer, foreignKey, serial, numeric, uniqueIndex } from "drizzle-orm/pg-core"
...
export const price = pgTable("Price", {
	...
	validFrom: timestamp("valid_from", { precision: 3, mode: 'string' }).notNull(),
